    ...
    <div className="min-h-svh grid place-items-center p-4 relative">
      ...
      <div className="w-full max-w-md rounded-xl border border-slate-800/60 bg-slate-900/70 p-6 shadow-2xl backdrop-blur">
        <div className="mb-4 text-center">
          <div className="mx-auto size-12 rounded-lg bg-cyan-500/20 ring-1 ring-cyan-400/30 grid place-items-center font-bold text-cyan-300">D</div>
          <h1 className="text-xl font-semibold mt-2">Digital Campaign Intelligence</h1>
          <p className="text-sm text-muted-foreground">Secure access portal</p>
        </div>
        <form className="space-y-3" onSubmit={handleSignIn}>
          <Input autoFocus placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} className="bg-slate-900 border-slate-800" />
