      ...
      <main className="relative z-10 px-6">
        <section className="mx-auto max-w-5xl text-center pt-16 pb-10">
          ...
          <p className="mt-4 text-sm md:text-base text-muted-foreground">
            A modern intelligence dashboard to surface coordinated networks,
            cross‑platform narratives, and emerging threats — in real time.
          </p>
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <a
              href="#learn"
              className="text-cyan-300 text-sm underline decoration-cyan-700/40 hover:decoration-cyan-400"
            >
              Learn more
            </a>
          </div>
        ...
        >
          <FeatureCard
            ...
            desc="Identify clusters, timelines, and account linkages behind trending narratives."
            accent="from-cyan-500/20 to-emerald-500/10"
          />
          <FeatureCard
            title="Classifier"
            desc="Differentiate legitimate criticism from hostile propaganda with transparent signals."
            accent="from-rose-500/20 to-amber-500/10"
          />
          <FeatureCard
            title="Multilingual Normalization"
            desc="Normalize code‑mixed, slang‑heavy content across languages for consistent analysis."
        ...
        <section className="mx-auto max-w-6xl mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-xl border border-slate-800/60 bg-gradient-to-br from-slate-900/80 to-slate-950/60 p-6">
            ...
            <ul className="text-sm space-y-2 text-muted-foreground list-disc pl-5">
              ...
              <li>
                Attribution support via network graphs and account footprints
              </li>
          ...
          <div className="rounded-xl border border-slate-800/60 bg-gradient-to-br from-slate-900/80 to-slate-950/60 p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Narrative warfare evolves rapidly. A unified, explainable view of
              accounts, hashtags, and content helps separate organic discourse
              from coordinated harm.
            </p>
            <div className="mt-4">
              <Link to="/login">
                <Button size="sm">Proceed to Secure Login</Button>
              </Link>
            </div>
          </div>
        </section>
...
function FeatureCard({
  ...
  return (
    <div
      className={`rounded-xl border border-slate-800/60 bg-gradient-to-br ${accent} p-5`}
    >
