...
export function generateTopK(seed=Date.now()) {
  ...
  const topics = [
    "election rally", "policy controversy", "media bias claim", "bot network spike", "T20 clash tonight",
    "misinfo takedown", "hashtag brigading", "coordinated trend", "geo-targeted push", "astro-turfing"
  ];
